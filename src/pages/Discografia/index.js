  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      >
        ...
        <List>
          {[
            { text: 'Álbuns', path: '/albuns', icon: <InboxIcon /> },
            { text: 'Todas as Faixas', path: '/faixas', icon: <MailIcon /> },
            { text: 'Contato', path: '/contato', icon: <InboxIcon /> },
            { text: 'Biografia', path: '/biografia', icon: <MailIcon /> },
          ].map((item) => (
